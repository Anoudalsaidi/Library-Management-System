     ...
     public static void BorrowBook()
        {
           ...
           Member checkid = context.members.FirstOrDefault(item => item.MemberID == memberId);
            ...
            //generated by system
            int loadID = context.loans.Count + 1;

            //user input
            Console.WriteLine("Enter Borrow Date: ");
            string borrowdate = Console.ReadLine();

            Console.WriteLine("Enter Return Date: note: More than 14 days fine will calculate");
            int returndate =int.Parse( Console.ReadLine());
            ...
            if (returndate > 14)
            {
                int latereturn = returndate + 14 ;
                double fine = latereturn * 0.25;
                Console.WriteLine($"Late total Days: {latereturn} with Fine : {fine}");

            }
            else
            {
                Console.WriteLine("No late days & no fine");
            }
